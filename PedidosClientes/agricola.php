...
<div class="jumbotron">
    <h4 class="display-3">Agrícola</h4>
    <hr class="my-2">
</div>
<?php if($paso==0){?>
<div class="row">
    <div class="row">
        ...
        <div class="col-md-4 contenedor">
            <div class="card">
                <img class="card-img-top" src="img\Agricola\campo.png" alt="">
                <div class="card-body">
                    <h4 class="card-title">Campo</h4>
                    <form action="" method="post">
                        <button type="submit" name="accion" value="Campo" class="btn btn-outline-primary" style="margin-left:30%">Más Información<i class="fa-sharp fa-solid fa-angles-right"></i></button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 contenedor">
            <div class="card">
                <img class="card-img-top" src="img\Agricola\logistica.png" alt="">
                <div class="card-body">
                    <h4 class="card-title">Logística</h4>
                    <form action="" method="post">
                        <button type="submit" name="accion" value="Logistica" class="btn btn-outline-primary" style="margin-left:30%">Más Información<i class="fa-sharp fa-solid fa-angles-right"></i></button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 contenedor">
            <div class="card">
                <img class="card-img-top" src="img\Agricola\mercado.png" alt="">
                <div class="card-body">
                    <h4 class="card-title">Mercado</h4>
                    <form action="" method="post">
                        <button type="submit" name="accion" value="Mercado" class="btn btn-outline-primary" style="margin-left:30%">Más Información<i class="fa-sharp fa-solid fa-angles-right"></i></button>
                    </form>
                </div>
            </div>
        </div>
